...
attributes for accounts numnber, account holder name, and account balance. Include methods to
deposit money, withdrt money, and display the account balance. Ensure that the account balance
...
class BankAccount:
  ...
  def display_balance(self):
      print("Account balance for {} Account #{}): ₹{}".format(
        self.__account_holder_name, self.__account_balance,
        self.__account_balance)) 
